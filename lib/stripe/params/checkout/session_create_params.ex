...
defmodule Stripe.Params.Checkout.SessionCreateParams do
  ...
  * `type` - The type of calculation to use on the shipping rate. Possible values: `fixed_amount`.
  ...
  @type shipping_options_shipping_rate_data :: %{
          ...
          optional(:display_name) => String.t() | nil,
          optional(:fixed_amount) => shipping_options_shipping_rate_data_fixed_amount() | nil,
          optional(:metadata) => %{String.t() => String.t()} | nil,
          optional(:tax_behavior) => String.t() | nil,
          optional(:tax_code) => String.t() | nil,
          optional(:type) => String.t() | nil,
  ...
  * `currency_options` - Shipping rates defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
  ...
  @type shipping_options_shipping_rate_data_fixed_amount :: %{
          ...
          optional(:currency_options) =>
            %{String.t() => shipping_options_shipping_rate_data_fixed_amount_currency_options()}
            | nil,
          optional(String.t()) => term()
        }
  ...
  * `trial_settings` - Settings related to subscription trials.
  ...
  @type subscription_data :: %{
          ...
          optional(:pending_invoice_item_interval) =>
            subscription_data_pending_invoice_item_interval() | nil,
  ...
  * `interval_count` - The number of intervals between invoices. For example, `interval=month` and `interval_count=3` bills every 3 months. Maximum of one year interval allowed (1 year, 12 months, or 52 weeks).
  """
  @type subscription_data_pending_invoice_item_interval :: %{
          optional(:interval) => String.t() | nil,
          optional(:interval_count) => integer() | nil,
          optional(String.t()) => term()
        }

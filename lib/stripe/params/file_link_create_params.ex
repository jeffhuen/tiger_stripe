...
defmodule Stripe.Params.FileLinkCreateParams do
  @moduledoc "Parameters for file link create."

  @typedoc """
  * `expand` - Specifies which fields in the response should be expanded.
  * `expires_at` - The link isn't usable after this future timestamp. Format: Unix timestamp.

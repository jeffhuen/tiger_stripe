...
defmodule Stripe.Params.InvoiceCreateParams do
  ...
  * `shipping_rate_data` - Parameters to create a new ad-hoc shipping rate for this order.
  ...
  @type shipping_cost :: %{
          ...
          optional(:shipping_rate_data) => shipping_cost_shipping_rate_data() | nil,
          optional(String.t()) => term()
        }
  ...
  * `type` - The type of calculation to use on the shipping rate. Possible values: `fixed_amount`.
  ...
  @type shipping_cost_shipping_rate_data :: %{
          optional(:delivery_estimate) =>
            shipping_cost_shipping_rate_data_delivery_estimate() | nil,
          optional(:display_name) => String.t() | nil,
          optional(:fixed_amount) => shipping_cost_shipping_rate_data_fixed_amount() | nil,
  ...
  * `minimum` - The lower bound of the estimated range. If empty, represents no lower bound.
  """
  @type shipping_cost_shipping_rate_data_delivery_estimate :: %{
          optional(:maximum) =>
            shipping_cost_shipping_rate_data_delivery_estimate_maximum() | nil,
          optional(:minimum) =>
            shipping_cost_shipping_rate_data_delivery_estimate_minimum() | nil,
          optional(String.t()) => term()
        }
  ...
  * `value` - Must be greater than 0.
  """
  @type shipping_cost_shipping_rate_data_delivery_estimate_maximum :: %{
  ...
  * `value` - Must be greater than 0.
  """
  @type shipping_cost_shipping_rate_data_delivery_estimate_minimum :: %{
          optional(:unit) => String.t() | nil,
          optional(:value) => integer() | nil,
          optional(String.t()) => term()
        }
  ...
  * `currency_options` - Shipping rates defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
  """
  @type shipping_cost_shipping_rate_data_fixed_amount :: %{
          optional(:amount) => integer() | nil,
          optional(:currency) => String.t() | nil,
          optional(:currency_options) =>
            %{String.t() => shipping_cost_shipping_rate_data_fixed_amount_currency_options()}
            | nil,
          optional(String.t()) => term()
        }
  ...
  * `tax_behavior` - Specifies whether the rate is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Possible values: `exclusive`, `inclusive`, `unspecified`.
  """
  @type shipping_cost_shipping_rate_data_fixed_amount_currency_options :: %{
          optional(:amount) => integer() | nil,
          optional(:tax_behavior) => String.t() | nil,
          optional(String.t()) => term()
        }

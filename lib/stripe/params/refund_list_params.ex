...
defmodule Stripe.Params.RefundListParams do
  @moduledoc "Parameters for refund list."
  ...
  * `payment_intent` - Only return refunds for the PaymentIntent specified by this ID. Max length: 5000.

...
defmodule Stripe.Resources.Issuing.Dispute do
  ...
  * `treasury` - [Treasury](https://docs.stripe.com/api/treasury) details related to this dispute if it was created on a [FinancialAccount](https://docs.stripe.com/api/treasury/financial_accounts) Nullable. Expandable.
  """
  @type t :: %__MODULE__{}

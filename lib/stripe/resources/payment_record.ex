...
defmodule Stripe.Resources.PaymentRecord do
  ...
  * `brand` - Card brand. Can be `amex`, `cartes_bancaires`, `diners`, `discover`, `eftpos_au`, `jcb`, `link`, `mastercard`, `unionpay`, `visa` or `unknown`. Possible values: `amex`, `cartes_bancaires`, `diners`, `discover`, `eftpos_au`, `interac`, `jcb`, `link`, `mastercard`, `unionpay`, `unknown`, `visa`. Nullable.
  ...
  * `funding` - Card funding type. Can be `credit`, `debit`, `prepaid`, or `unknown`. Possible values: `credit`, `debit`, `prepaid`, `unknown`. Nullable.
  ...
  * `cryptogram` - The 3D Secure cryptogram, also known as the "authentication value" (AAV, CAVV or AEVV). Max length: 5000. Nullable.
  * `electronic_commerce_indicator` - The Electronic Commerce Indicator (ECI). A protocol-level field indicating what degree of authentication was performed. Possible values: `01`, `02`, `03`, `04`, `05`, `06`, `07`. Nullable.
  ...
  * `exemption_indicator_applied` - Whether Stripe requested the value of `exemption_indicator` in the transaction. This will depend on the outcome of Stripe's internal risk assessment. Nullable.
  ...
  * `verified_name` - Owner's verified full name. Values are verified or provided by iDEAL directly (if supported) at the time of authorization or settlement. They cannot be set or mutated. Max length: 5000. Nullable.
  """
  ...
  * `generated_sepa_debit_mandate` - The mandate for the SEPA Direct Debit PaymentMethod which was generated by this Charge. Nullable.
  * `iban_last4` - Last four characters of the IBAN. Max length: 5000. Nullable.
  * `preferred_language` - Preferred language of the SOFORT authorization page that the customer is redirected to. Can be one of `de`, `en`, `es`, `fr`, `it`, `nl`, or `pl` Possible values: `de`, `en`, `es`, `fr`, `it`, `nl`, `pl`. Nullable.
  * `verified_name` - Owner's verified full name. Values are verified or provided by SOFORT directly (if supported) at the time of authorization or settlement. They cannot be set or mutated. Max length: 5000. Nullable.
  """

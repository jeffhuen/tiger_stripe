...
defmodule Stripe.Resources.Reserve.Plan do
  ...
  * `type` - The type of the ReservePlan. Possible values: `fixed_release`, `rolling_release`.
  ...
  @type t :: %__MODULE__{
          ...
          currency: String.t(),
          disabled_at: integer(),
          fixed_release: fixed_release() | nil,
          id: String.t(),
          livemode: boolean(),
          metadata: %{String.t() => String.t()} | nil,
          object: String.t(),
          percent: integer(),
          rolling_release: rolling_release() | nil,
          status: String.t(),
          type: String.t()
        }
  ...
  * `scheduled_release` - The time at which reserved funds are scheduled for release, automatically set to midnight UTC of the day after `release_after`. Format: Unix timestamp.
  """
  @type fixed_release :: %{
          optional(:release_after) => integer() | nil,
          optional(:scheduled_release) => integer() | nil,
  ...
  * `expires_on` - The time at which the ReservePlan expires. Nullable.
  ...
  @type rolling_release :: %{
          optional(:days_after_charge) => integer() | nil,
          optional(:expires_on) => integer() | nil,
          optional(String.t()) => term()
        }

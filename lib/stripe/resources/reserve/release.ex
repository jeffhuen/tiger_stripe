...
defmodule Stripe.Resources.Reserve.Release do
  ...
  * `source_transaction` - Expandable.
  ...
  @type t :: %__MODULE__{
          ...
          source_transaction: __MODULE__.SourceTransaction.t() | nil
        }
  ...
  defmodule SourceTransaction do
    ...
    * `type` - The type of source transaction. Possible values: `dispute`, `refund`.
    """
    @type t :: %__MODULE__{
            dispute: String.t() | Stripe.Resources.Dispute.t() | nil,
            refund: String.t() | Stripe.Resources.Refund.t() | nil,
            type: String.t() | nil
          }
    defstruct [:dispute, :refund, :type]
  end

  def __inner_types__ do
    %{
      "source_transaction" => __MODULE__.SourceTransaction
    }
  end
end
